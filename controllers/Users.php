    ...
    //creacion de usuario en la base de datos 
{
    ...
    private function crearFirma($user)
    {
        ...
        //posicionamiento en cordenadas de los datos recibidos 
        ...
        // $nombre_firma = $nombre . '_' . $apellido_1 . '_firma.jpeg';


        imagedestroy($plantilla);

        // $rutaFirma = "/var/www/html/Nfirma/assets/firmas/imag" . $nombre_firma;

        $nombre_firma = "assets/images/firma/" . $nombre . '_' . $apellido_1 . '_firma.jpeg';
        imagejpeg($plantilla, $nombre_firma);


        // $rutaFirma = "assets/firmas/" . $nombre_firma;
        $rutaFirma = $nombre_firma;

        header('Location: Views/vistaFirma.php?rutaFirma=' . $rutaFirma);
